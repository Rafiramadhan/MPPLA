    ...
    <main>
      ...
      <nav class="navbar navbar-custom navbar-fixed-top navbar-transparent" role="navigation">
        <div class="container">
          <div class="navbar-header">
           <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="index2.php">Mega Jaya</a>
          </div>
      ...
      <section class="home-section home-fade home-full-height" id="home">
        <div class="hero-slider">
          <ul class="slides">
            <li class="bg-dark-30 bg-dark shop-page-header" style="background-image:url(&quot;assets/images/admin1.jpg&quot;);">
              <div class="titan-caption">
                <div class="caption-content">
                  <div class="font-alt mb-30 titan-title-size-1">Jadilah Mitra Mega Jaya</div>
                  <div class="font-alt mb-30 titan-title-size-4"></div>
                  <div class="font-alt mb-40 titan-title-size-1">Pesan Sebanyak banyaknya</div>
                </div>
              </div>
            </li>
            <!--
      ...
      <div class="main">
        <section class="module-small" id="produksi">
          <div class="container">
            <div class="row">
            ...
            <div class="row multi-columns-row">
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="shop-item">
                  <div class="shop-item-image"><img src="assets/images/shop/bakpaokeju.jpg" alt="Accessories Pack"/>
                    <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Masukan Ke Pemesanan</span></a></div>
                  </div>
                  <h4 class="shop-item-title font-alt"><a href="#">Keju</a></h4>Rp.3100
                </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="shop-item">
                  <div class="shop-item-image"><img src="assets/images/shop/bakpaokacangtanah.jpg" alt="Men’s Casual Pack"/>
                    <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Masukan Ke Pemesanan</span></a></div>
                  </div>
                  <h4 class="shop-item-title font-alt"><a href="#">Kacang Tanah</a></h4>Rp.3000
                </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="shop-item">
                  <div class="shop-item-image"><img src="assets/images/shop/bakpaokacanghijau.jpg" alt="Men’s Garb"/>
                    <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Masukan Ke Pemesanan</span></a></div>
                  </div>
                  <h4 class="shop-item-title font-alt"><a href="#">Kacang Hijau</a></h4>Rp.3000
                </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="shop-item">
                  <div class="shop-item-image"><img src="assets/images/shop/bakpaoayam.jpg" alt="Cold Garb"/>
                    <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Masukan Ke Pemesanan</span></a></div>
                  </div>
                  <h4 class="shop-item-title font-alt"><a href="#">Ayam</a></h4>Rp.3500
                </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="shop-item">
                  <div class="shop-item-image"><img src="assets/images/shop/bakpaocoklat.jpg" alt="Accessories Pack"/>
                    <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Masukan Ke Pemesanan</span></a></div>
                  </div>
                  <h4 class="shop-item-title font-alt"><a href="#">Coklat</a></h4>Rp.3100
                </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="shop-item">
                  <div class="shop-item-image"><img src="assets/images/shop/bakpaostraw.jpg" alt="Men’s Casual Pack"/>
                    <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Masukan Ke Pemesanan</span></a></div>
                  </div>
                  <h4 class="shop-item-title font-alt"><a href="#">Strawberry</a></h4>Rp.3100
                </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="shop-item">
                  <div class="shop-item-image"><img src="assets/images/shop/bakpaotelo.jpg" alt="Men’s Garb"/>
                    <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Masukan Ke Pemesanan</span></a></div>
                  </div>
                  <h4 class="shop-item-title font-alt"><a href="#">Telo</a></h4>Rp.3000
                </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="shop-item">
                  <div class="shop-item-image"><img src="assets/images/shop/bakpaokelapa.jpg" alt="Cold Garb"/>
                    <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Masukan Ke Pemesanan</span></a></div>
                  </div>
                  <h4 class="shop-item-title font-alt"><a href="#">Kelapa</a></h4>Rp.3000
                </div>
              </div>
            </div>
            <div class="row mt-30">
              <div class="col-sm-12 align-center"><a class="btn btn-b btn-round" href="shop_checkout.html">Pemesanan</a></div>
            </div>
          </div>
        </section>

          <hr class="divider-w">
        <section class="module" id="Ketersediaan">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title font-alt">Ketersediaan Bakpao</h2>
                ...
                <table class="table table-striped table-border checkout-table">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <tr>
                      <td class="hidden-xs"><a href="#"><img src="assets/images/shop/bakpaokacanghijau.jpg" alt="Accessories Pack"/></a></td>
                      <td>
                      ...
                      <tr>
                      <td class="hidden-xs"><a href="#"><img src="assets/images/shop/bakpaoayam.jpg" alt="Accessories Pack"/></a></td>
                      <td>
                      ...
                      <tr>
                      <td class="hidden-xs"><a href="#"><img src="assets/images/shop/bakpaocoklat.jpg" alt="Accessories Pack"/></a></td>
                      <td>
                      ...
                      <tr>
                      <td class="hidden-xs"><a href="#"><img src="assets/images/shop/bakpaostraw.jpg" alt="Accessories Pack"/></a></td>
                      <td>
                      ...
                      <tr>
                      <td class="hidden-xs"><a href="#"><img src="assets/images/shop/bakpaotelo.jpg" alt="Accessories Pack"/></a></td>
                      <td>
                      ...
                      <tr>
                      <td class="hidden-xs"><a href="#"><img src="assets/images/shop/bakpaokelapa.jpg" alt="Accessories Pack"/></a></td>
                      <td>
