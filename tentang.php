...
<html lang="en-US" dir="ltr">
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
           <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="index.php">Mega Jaya</a>
          </div>
      ...
      <div class="main">
        <section class="module bg-dark-60 about-page-header" data-background="assets/images/logobakpao.jpg">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title font-alt">Tentang Kami</h2>
                <div class="module-subtitle font-serif"> Bakpao Mega Jaya.</div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6">
                ...
                <h3>Bakpao adalah makanan yang berasal dari negeri China, berbahan dasar tepung terigu yang diberi ragi sehingga mengembang, kemudian diberi aneka isian dan dikukus.Bak berarti daging, sedang pao sendiri berarti bungkusan. Jadi, bakpao berarti “bungkusan-daging”. Di negeri panda, bakpao dikenal dengan sebutan BaoZi. Harga yang murah serta varian isi yang beragam membuat bakpao banyak digemari sebagai cemilan ataupun makanan penunda lapar.</h3>
                <h3>Salah satu bisnis bakpao yang tergolong sukses serta membuka cukup banyak lapangan pekerjaan adalah bakpao “Mega Jaya”. Hadir sejak tahun 1995 dengan nama “lien” sebelum kemudian sempat terhenti karena tragedi 1998 dan berganti nama menjadi “Mega Jaya”. Adalah pak Sahir, bapak dari 5 anak ini hanya mengemban pendidikan hingga SD, itupun tidak sempat lulus. Pak Sahir kini menikmati hasil dari kerja kerasnya dalam usaha bakpao ini.</h3>
              </div>
              <div class="col-sm-6">
          ...
          <div class="container">
            ...
            <div class="row">
              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3">
                <div class="team-item">
                  <div class="team-image"><img src="assets/images/sahir.jpg" alt="Member Photo"/>
                    <!--
                  ...
                  <div class="team-descr font-alt">
                    <div class="team-name">Pak Sahir</div>
              ...
              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3">
                <div class="team-item">
                  <div class="team-image"><img src="assets/images/ivan.jpg" alt="Member Photo"/>
                    <!--
                    <div class="team-detail">
                  ...
                  <div class="team-descr font-alt">
                    ...
                    <div class="team-role">Keuangan</div>
                  </div>
                </div>
              </div>
              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3">
                <div class="team-item">
                  <div class="team-image"><img src="assets/images/rafi.jpg" alt="Member Photo"/>
                    <!--
                    <div class="team-detail">
              ...
              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3">
                <div class="team-item">
                  <div class="team-image"><img src="assets/images/yuga.jpg" alt="Member Photo"/>
                    <!--
                    <div class="team-detail">
                  ...
                  <div class="team-descr font-alt">
                    <div class="team-name">Yuga Mitra</div>
            ...
            <div class="row">
              <div class="col-sm-8">
                <form id="contactForm" role="form" method="post" action="php/contact.php">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="name" name="name" placeholder="Nama*" required="required" data-validation-required-message="Please enter your name."/>
                  ...
                  <div class="form-group">
                    <textarea class="form-control" rows="7" id="message" name="message" placeholder="Pesan*" required="required" data-validation-required-message="Please enter your message."></textarea>
                    <p class="help-block text-danger"></p>
                  </div>
              ...
              <div class="col-sm-4">
                <div class="alt-features-item mt-0">
                  ...
                  <h3 class="alt-features-title font-alt">Lokasi</h3>Mega Jaya<br/> Mulyorejo 2 No. 27<br/>Surabaya, Jawa Timur
                </div>
                <div class="alt-features-item mt-xs-60">
                  <div class="alt-features-icon"><span class="icon-map"></span></div>
                  <h3 class="alt-features-title font-alt">Hubungi</h3> Megajaya@gmail.com<br/>081216042008 (wa) / 085648970008
                </div>
              </div>
            </div>
          </div>
