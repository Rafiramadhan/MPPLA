...
<html lang="en-US" dir="ltr">
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      <section class="home-section home-full-height bg-dark bg-gradient" id="home" data-background="assets/images/administrator1.jpg">
          ...
          <div class="container">
                  ...
                  <tbody>
                    ...
                    <tr>
                     ...
                     <tr>
                      ...
                      <td>
                        <h5 class="product-title font-alt"><a href="lihathasiljual.php">Tegar Satrio</a></h5>
                      </td>
                     ...
                     <tr>
                      ...
                      <td>
                        <h5 class="product-title font-alt"><a href="lihathasiljual.php">Ivan Fadhila</a></h5>
                      </td>
                     ...
                     <tr>
                      ...
                      <td>
                        <h5 class="product-title font-alt"><a href="lihathasiljual.php">Adam Alfian</a></h5>
                      </td>
                     ...
                     <tr>
                      ...
                      <td>
                        <h5 class="product-title font-alt"><a href="lihathasiljual.php">Yuga Mitra</a></h5>
                      </td>
            ...
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                ...
                <form class="form" role="form">
                  <div class="form-group">
                    <input class="form-control input-lg" type="text" placeholder="Nama Penjual"/>
                  </div>
                  <div class="form-group">
                 ...
                 <hr class="divider-w mt-10 mb-20">
                <p class="btn-list">
                  <a href="index_administrator.php" class="btn btn-g btn-round" type="submit">Tambahkan</a>&nbsp;
              </div>
      ...
      <section class="module bg-dark-60 pt-0 pb-0 parallax-bg testimonial" data-background="assets/images/administrator2.jpg">
      ...
      <section class="module" id="riwayat">
          ...
          <section class="module bg-dark-60 pt-0 pb-0 parallax-bg testimonial" id="kritik" data-background="assets/images/administrator2.jpg">
          <div class="testimonials-slider pt-140 pb-140">
            <ul class="slides">
              <li>
                <div class="container">
        ...
        <!--
        <section class="module bg-dark-60"  id="bantuan" data-background="assets/images/section-3.jpg">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title font-alt">Bantuan</h2>
                <div class="module-subtitle font-serif"></div>
              </div>
            </div>
