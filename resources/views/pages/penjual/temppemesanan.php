...
<form name='autoSumForm'>
    <table border='0' width='80%' align='center'>
        <tr>
            ...
            <td><input type='text' name='angsuran_pokok' style="text-align:right;" size='23' onFocus="startCalc();"
                       onBlur="stopCalc();"/></td>
        </tr>
        <tr>
            <td><b>Angsuran Bunga</b></td>
            <td><input type='text' name='angsuran_bunga' style="text-align:right;" size='23' onFocus="startCalc();"
                       onBlur="stopCalc();"/></td>
        </tr>
        <tr>
            <td><b>Discount Angsuran</b></td>
            <td><input type='text' name="diskon" style="text-align:right;" size='23' onFocus="startCalc();"
                       onBlur="stopCalc();"/></td>
        </tr>
        <tr>
            <td>Jumlah</td>
