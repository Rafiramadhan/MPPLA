    ...
    <main>
      ...
      <nav class="navbar navbar-custom navbar-fixed-top navbar-transparent" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="#totop">Mega Jaya</a>
          </div>
      ...
      <section class="home-section home-full-height" id="home">
        <div class="hero-slider">
          <ul class="slides">
            <li class="bg-dark-30 restaurant-page-header bg-dark" style="background-image:url(&quot;assets/images/restaurant/megajaya1.jpg&quot;);">
            ...
            <li class="bg-dark-30 restaurant-page-header bg-dark" style="background-image:url(&quot;assets/images/restaurant/megajaya2.jpg&quot;);">
              <div class="titan-caption">
                <div class="caption-content">
                  <div class="font-alt mb-30 titan-title-size-2">Ayoo jadilah rakyat yg mencintai produk lokal dan halal tentunya
                </div>
              </div>
            </li>
            <li class="bg-dark-30 restaurant-page-header bg-dark" style="background-image:url(&quot;assets/images/restaurant/megajaya3.jpg&quot;);">
              <div class="titan-caption">
                <div class="caption-content">
                  <div class="font-alt mb-30 titan-title-size-1"> Rasakan Kenikmatannya</div>
                  <div class="font-alt mb-40 titan-title-size-3">Produk - Produk Kami</div><a class="section-scroll btn btn-border-w btn-round" href="#products">Klik Disini</a>
                </div>
              </div>
            </li>
          </ul>
      ...
      <div class="main">
            ...
            <div class="row multi-columns-row">
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="content-box">
                  <div class="content-box-image"><img src="assets/images/restaurant/bakpaocoklat.jpg" alt="Kabab"/></div>
                  <h3 class="content-box-title font-serif">Coklat</h3>
                </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="content-box">
                  <div class="content-box-image"><img src="assets/images/restaurant/bakpaostraw.jpg" alt="Limes"/></div>
                  <h3 class="content-box-title font-serif">Strawberry</h3>
                </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="content-box">
                  <div class="content-box-image"><img src="assets/images/restaurant/bakpaokeju.jpg" alt="Radish"/></div>
                  <h3 class="content-box-title font-serif">Keju</h3>
                </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="content-box">
                  <div class="content-box-image"><img src="assets/images/restaurant/bakpaoayam.jpg" alt="Corn"/></div>
        ...
        <section class="module module-video bg-dark-30" data-background="assets/images/restaurant/megajaya3.jpg">
          ...
          <div class="video-player" data-property="{videoURL:'https://www.youtube.com/watch?v=AIks1cYQdHI&t=297s', containment:'.module-video', startAt:3, mute:true, autoPlay:true, loop:true, opacity:1, showControls:false, showYTLogo:false, vol:25}"></div>
        </section>
